 ...
 */
let config = {
    darksky_api: "xxxxxxxxxxxxxxxxx", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "xxxxxxxxxxxxxxxxx", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "xxxxxxxxxxxxxxxxx", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "xxxxxxxxxxxxxxxxx", //请填写经纬度,直接从谷歌地图中获取即可
